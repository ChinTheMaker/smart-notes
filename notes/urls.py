...
from notes.views import track_tag_usage
...
from .views import restore_archived_note
...
urlpatterns = [
    ...
    path('notes/<int:id>/archive/', views.archive_note, name="archive-note"),
    path('notes/<int:id>/prioritize/', views.prioritize_note, name="prioritize-note"),
    path('recommendations/related-notes/', recommend_related_notes, name="recommend_related_notes"),
    path('reports/productivity/', views.productivity_report, name="productivity-report"),
    path('notes/set-reminder/', set_reminder, name='set-reminder'),
    ...
    path('reports/most-active-hours/', identify_most_active_hours, name='most-active-hours'),
    ...
    path('notes/<int:id>/restore/', restore_archived_note, name='restore_archived_note'),
    path('api/workflows/reminders/', views.list_reminders, name='list_reminders'),
    path('api/workflows/reminders/<int:id>/', views.get_reminder, name='get_reminder'),
]
